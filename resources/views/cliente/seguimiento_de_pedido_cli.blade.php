...
@section('contenido')
    <div class="p-4">
        <div class="flex justify-between items-center ">
            ...
            <div class="p-2 mb-4">
                <form action="{{ route('seguimiento_de_pedido_cli', ['id_pedido' => $id_pedido ?? null]) }}" method="GET">
                ...
                @if(request()->has('id_pedido'))
                    <a href="{{ route('cliente.seguimiento_de_pedido_cli') }}" class="text-blue-500 mt-2 block">Mostrar Todos</a>
                @endif
            </div>
        </div>

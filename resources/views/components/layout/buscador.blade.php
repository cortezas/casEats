<ul class="menu menu-horizontal lg:menu-horizontal rounded-box mx-5 flex justify-center m-2.5">
    <li class="mr-20 text-center dark:text-white">
        ...
        <span class="text-2xl font-extrabold leading-none tracking-tight md:text-2xl lg:text-2xl dark:text-gray-800">Burgers</span>
    </li>
    <li class="mr-20 text-center dark:text-white">
        ...
        <span class="text-2xl font-extrabold leading-none tracking-tight md:text-2xl lg:text-2xl dark:text-white">Bocadillos</span>
    </li>
    <li class="mr-20 text-center dark:text-white">
        ...
        <span class="text-2xl font-extrabold leading-none tracking-tight  md:text-2xl lg:text-2xl dark:text-white">Bebidas</span>
    </li>
    <li class="mr-20 text-center dark:text-white">
        ...
        <span class="text-2xl font-extrabold leading-none tracking-tight  md:text-2xl lg:text-2xl dark:text-white ml-2">Pizzas</span>
    </li>
    <li class="mr-20 text-center dark:text-white">
        ...
        <span class="text-2xl font-extrabold leading-none tracking-tight  md:text-2xl lg:text-2xl dark:text-white ml-1">Postres</span>
    </li>
    <li class="mr-20 text-center dark:text-white">
        ...
        <span class="text-2xl font-extrabold leading-none tracking-tight  md:text-2xl lg:text-2xl dark:text-white">Pescados</span>
    </li>
    <li class="mr-20 text-center dark:text-white">
        ...
        <span class="text-2xl font-extrabold leading-none tracking-tight  md:text-2xl lg:text-2xl dark:text-white">Carnes</span>
    </li>
    <li class="text-center dark:text-white">
        ...
        <span class="text-2xl font-extrabold leading-none tracking-tight  md:text-2xl lg:text-2xl dark:text-white ml-3">Otros</span>
    </li>
</ul>
